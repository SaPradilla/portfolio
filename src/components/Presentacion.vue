...
<template>
    ...
    <section class="contenedor ">
        <div class="contenedor-presentacion">
            ...
            <div class="acciones">
                <Button class="accion" @click="goContact('contact')" :label="t('Contacto')" raised outlined />
        ...
        <div class="iconos">
            ...
            <div class="ico">
                ...
                <a href="mailto:santypradilla1985@gmail.com" target="_blank">
