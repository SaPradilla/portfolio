...
<template>
    ...
    <div class="modal_proyecto">
        <!-- icon close -->
        <div class="  ">
            <Icon @click="$emit('closeCallback')" class=" absolute  right-1 top-1 text-2xl cursor-pointer z-10"
        ...
        <div class="content_desc">
            ...
            <!-- galeria  imagenes -->
            <Galleria :value="proyectos.currentProyect.images" :responsiveOptions="responsiveOptions" :numVisible="3"
                :circular="true" class="galleria">
                <template #item="slotProps">
                    <div class="content_img ">
                        <Image :src="slotProps.item.img" :alt="proyectos.currentProyect.title" width="300" height="150" preview/>                        
                    </div>
                </template>
                <template #thumbnail="slotProps">
                    <div class=" ">
                        <img :src="slotProps.item.thumbnail" :alt="proyectos.currentProyect.title"
                            style="width: 100%" />
                    </div>
                </template>
            </Galleria>
            ...
            <div class="modal_proyecto__descripcion">
                ...
                <p> {{ proyectos.currentProyect.description }}</p>
